...
{
    public class CardPanelCell : FancyScrollViewCell<ItemData, Context>
    {
        ...
        public override void UpdateContent(ItemData itemData)
        {
            ...
            transform.Find("Card_UI").GetComponent<BattleCard>().SetCardData(itemData.cardData);
            transform.Find("Card_UI").GetComponent<BattleCard>().UpdateUI();
