...
{
    public class ArmyManagePanelHero : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerMoveHandler
    {
        ...
        void Start()
        {
            ...
            heroIndex = int.Parse(gameObject.name);
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            panel.CurrMovingHero = gameObject;
            panel.OnHoverOutHeroItem(gameObject.GetComponent<HoverToShowUI>());
            isMoving = true;
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            panel.finishMovingHero(heroIndex, pos);
        }
    }
}
