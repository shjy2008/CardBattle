...
{
    public class EventManager : TSingleton<EventManager>, IManager
    {
        #region 数据
        private Dictionary<EventType, ArrayList> eventMapDic = new Dictionary<EventType, ArrayList>();//ArrayList存放的是不同T的Tiny<T>(比如说List有Tiny<T1>和Tiny<T2>等等),
                                                             //以便实现同一个eventType可以有不同的类型的handler[通过发事件传入的参数才确定类型]

        private Queue<object> eventParamsQue = new Queue<object>();//用于处理异步事件的事件参数队列

        private bool eventParamsQueMutex = false;//用于单线程内作加锁用(相当于TinyEvent的callnum)
        ...
        public void SendEventSync<T1>(EventType eventType, T1 arg1)
        {
            ArrayList list = null;
        ...
        public void SendEventSync<T1, T2>(EventType eventType, T1 arg1, T2 arg2)
        {
            ArrayList list = null;
        ...
        public void SendEventSync<T1, T2, T3>(EventType eventType, T1 arg1, T2 arg2, T3 arg3)
        {
            ArrayList list = null;
        ...
        public void SendEventSync<T1, T2, T3, T4>(EventType eventType, T1 arg1, T2 arg2, T3 arg3, T4 agr4)
        {
            ArrayList list = null;
        ...
        /// <param name="eventType"></param>
        /// <param name="arg1"></param>
        public void SendEventAsync<T1>(EventType eventType, T1 arg1)
        {
            ArrayList list = null;
            TinyEvent<Action<T1>> tinyEvt = null;
            if (eventMapDic.ContainsKey(eventType))
        ...
        /// <param name="arg1"></param>
        /// <param name="arg2"></param>
        public void SendEventAsync<T1, T2>(EventType eventType, T1 arg1, T2 arg2)
        {
            ArrayList list = null;
            TinyEvent<Action<T1, T2>> tinyEvt = null;
            if (eventMapDic.ContainsKey(eventType))
        ...
        /// <param name="arg2"></param>
        /// <param name="arg3"></param>
        public void SendEventAsync<T1, T2, T3>(EventType eventType, T1 arg1, T2 arg2, T3 arg3)
        {
            ArrayList list = null;
            TinyEvent<Action<T1, T2, T3>> tinyEvt = null;
            if (eventMapDic.ContainsKey(eventType))
        ...
        public void SendEventAsync<T1, T2, T3, T4>(EventType eventType, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            ArrayList list = null;
            TinyEvent<Action<T1, T2, T3, T4>> tinyEvt = null;
            if (eventMapDic.ContainsKey(eventType))
